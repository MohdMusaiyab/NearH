    ...
    <div className="flex min-h-screen">
      ...
      <div className="w-1/2 bg-blue-500 flex justify-center items-center p-8">
        <div className="w-full max-w-md">
          <h2 className="text-2xl font-semibold mb-6 text-white">Hospital Sign Up</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            {/* Submit Button */}
            <button type="submit" className="bg-white text-blue-500 px-4 py-2 rounded-md hover:bg-gray-200 transition duration-300">Sign Up</button>
          </form>

          {/* Link to Registration Page */}
          <p className="mt-4 text-sm text-white">
            Already have an account? <Link to="/sign-in" className="hover:underline">Sign In</Link>
          </p>
        </div>
      </div>
